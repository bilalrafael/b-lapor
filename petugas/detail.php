<?php
     include "../template/petugas/header.php"
?>
  ...
  <form action="p_input_menu.php" method="POST">
    <div class="card-body">
      ...
      <div class="form-group cols-sm-6 my-2">
        ...
        <a href="../proses/petugas/verifikasi_petugas.php?id=<?php echo $hasil['id_pengaduan'];?>" class="btn btn-danger btn-icon-split" onclick="return confirm('Yakin untuk verifikasi ?')">
          <span class="icon text-white-50">
